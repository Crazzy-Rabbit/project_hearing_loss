#=============================================================#
# # # plot per SNP heritability enrichment in GWFM
#=============================================================#

library(data.table)
setwd("E:/Shi/ALL_of_my_Job/24-28川大华西/2_project_hearing loss/process/gctb")
res = fread("ARHL_MVP_AJHG_BBJ_reformatMETAL_gctb_SbayesRC.parSetRes",head=F,check.names=F)
...
catesNew = c("Conding","Conserved_LindbladToh","Enhancer_Andersson","H3H27ac",
             "H3K4me3","H3K9ac","Intron","Repressed","Transcription","TSS",
             "UTR_3","UTR_5","GERP","MAFbin3","MAFbin8","Synonymous","Non_synonymous","Conversed_Vertebrate","Conserved_Mammal","Conserved_Primate",
             "BivFlank","Promoter","Promoter_ancient","Enhancer_ancient","Promoter_ExAC")
